...
{
    const string privateCode = "0G9i85ZpwEyvnDkfijEIuAV091aiY4OkG3sZUNZb4Xpw";  //Key to Upload New Info
    const string publicCode = "6353facd8f40bb11d8c3cbea";   //Key to download
    ...
    IEnumerator DatabaseDownload()
    {
        ...
        if (string.IsNullOrEmpty(www.error))
        {
            ...
            highscoresDisplay.SetScoresToMenu(scoreList);
        }
        else print("Error uploading" + www.error);
    }
